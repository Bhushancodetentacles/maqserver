...
export default function Header({ onDataChanged }) {
  ...
  <>
      ...
      <nav className={isMenuOpen ? "fixed header-nav-hidden top-0 right-0 z-40 transition-colors duration-300" :"fixed top-0 header-nav right-0 z-40 transition-colors duration-300" }
        >
          <div className="lg:max-w-full md:max-w-screen-xl  flex  items-center justify-between py-2 px-4">
<div className="flex">
       <Link to="/admin/admin-dashboard"  className="flex lg:hidden items-center"> 
          <img src="../../assets/images/logo.png" className="h-8 mr-3" width="80" alt="logo" /> 
           </Link>
            <button
              type="button"
            ...
            <div className=" flex justify-end  w-full md:flex md:w-auto md:order-1"
              id="navbar-sticky">
                ...
                <li style={{marginLeft:"0px"}}>
                  <Menu>
                    ...
                    <Menu.Button className="flex relative text-white text-sm items-center ">
                      ...
                      <span className="hidden lg:block md:block">Ruchita Sonar</span>
                    </Menu.Button>
                    <Transition
                      as={Fragment}

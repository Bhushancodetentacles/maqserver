              ...
              <div className="activate-content rounded ">
                <div className="grid md:grid-cols-2 lg:grid-cols-2  gap-2">
                  <div>
                    ...
                    <input
                      type="text"
                      className="referral-input1 relative"
                      placeholder="100 USDT"
                    />
                    <button className="Copy-btn rounded text-white px-4">
                      Withdraw Amount
                    </button>
                  </div>
                </div>
              </div>
              <div className="table-content mt-5 rounded">
                <div className="wrap">
                  ...
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                      <tr className="border-b text-base text-gray-200 ">
                        ...
                        <td className="px-6 py-4 text-center">10 USDT</td>
                      </tr>
                      <tr className="border-b text-base text-gray-200 ">
                        <th scope="row" className="text-center px-6 py-4 ">
                          2

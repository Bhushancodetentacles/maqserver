 ...
 "use strict";
    ...
    jQuery(document).ready(function($){
        /* \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
                  Password show/hide
        \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\ */
        $('.pas_show').append('<i className="ptxt ti-eye"></i>');  
      ...
      $(".custom_select").each(function() {
        var classes = $(this).attr("class"),
            name    = $(this).attr("name");
        var template =  '<div className="' + classes + '">';
            template += '<div className="custom_select_trigger">' + $(this).attr("data-value") + '</div>';
            template += '<ul className="custom_options">';
            $(this).find("option").each(function() {
              template += '<li className="custom_option ' + $(this).attr("class") + '" data-value="' + $(this).attr("value") + '">' + $(this).html() + '</li>';
            });
        template += '</ul></div>';
        
        $(this).wrap('<div className="custom_select_wrapper"></div>');
        $(this).hide();
        $(this).after(template);
      });

...
// 	'<div className="styler-trigger-cover"></div>' +
// 	'<div className="color-styler-wrapper">' +
// 		'<div className="color-styler">' +
// 			'<div className="gear styler-trigger">' +
// 				'<span className="icon-gear custom-spin"></span>' +
// 			'</div>' +
// 			'<div className="styler-menu-scroll-wrapper">' +
// 				'<div className="styler-menu-scroll-scroller">' +
// 					'<div className="styler-menu">' +
// 						'<header>' +
// 							'<h5 className="styler-title">Choose Your Colors</h5>' +
// 						'</header>' +
// 						'<main>' +
...
// 							'<a id="getCSSLauncher" href="#" className="btn btn-outline-light mb-3" data-bs-toggle="modal" data-bs-target="#codeModal">GET CSS</a>' +
// 							'<a href="https://1.envato.market/qn6L9N" className="btn btn-gradient-outline-hard" target="_blank">BUY NOW</a>' +
// 						'</div>' +
// 					'</div><!-- /.styler-menu -->' +
...
// 	'<div className="modal fade" id="codeModal" tabindex="-1" role="dialog" aria-labelledby="codeModalLabel" aria-hidden="true">' +
// 		'<div className="modal-dialog" role="document" style="width: 960px; max-width: 90%;">' +
// 			'<div className="modal-content">' +
// 			'<div className="modal-header">' +
// 				'<div className="modal-header-heading">' +
// 					'<h5 className="modal-title" id="codeModalLabel">Copy Your New CSS Color Styles</h5>' +
// 				'</div>' +
// 				'<div className="modal-header-menu">' +
// 					'<button className="copyToClip sk__get-code-buttons" data-clipboard-target="#stylesForDwnLoad" title="Copy The Code">' +
// 						'<span className="icon-clone"></span><span className="ctClip">Copy The Code</span>' +
// 					'</button>' +
// 					'<div className="copyDone unappeared sk__gradient-back-v1"><p>Copied to Clipboard!<br>You can now paste over the code in<br><strong>theme-colors.css<strong></p></div>' +
// 					'<!-- <button id="downloadLinkTop" className="sk__get-code-buttons" data-clipboard-target="#stylesForDwnLoad" title="Download as CSS file">' +
// 						'<i className="fa fa-download"></i>' +
// 					'</button> -->' +
// 					'<button data-bs-dismiss="modal" className="closeModal sk__get-code-buttons" data-clipboard-target="#stylesForDwnLoad" title="Close">' +
// 						'<span className="icon-clear"></span>' +
// 					'</button>' +
// 				'</div>' +
// 			'</div>' +
// 			'<div className="modal-body">' +
// 				'<div className="color-styles-copy">' +
// 					'<pre>' +
